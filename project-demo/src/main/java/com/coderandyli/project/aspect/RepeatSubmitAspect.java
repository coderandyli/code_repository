package com.coderandyli.project.aspect;

import com.coderandyli.project.annotation.RepeatSubmit;
...
public class RepeatSubmitAspect {
     ...
     * 切入点
     */
    @Pointcut("@annotation(com.coderandyli.project.annotation.RepeatSubmit)")
    ...
    public Object around(ProceedingJoinPoint point, RepeatSubmit repeatSubmit) {
        ...
        if (isLock) {
            ...
            try {
                ...
                Boolean unloack = redisLock.unlock(key, value);
                if (!unloack) {
